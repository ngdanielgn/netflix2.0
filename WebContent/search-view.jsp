...
<head>
	...
	<script src="AutoComplete_Script.js"></script>
</head>
			...
			<form class="form-horizontal" action="FabflixControllerServlet" method="GET">
				...
				<fieldset>
					...
					<div class="form-group">
						<label class="col-md-4 control-label" for="txtStreet">Auto Completion Search</label>  
						<div class="col-md-4">
						<input id="auto" name="AutoComplete" type="text" placeholder="Auto Search" class="form-control input-md" onkeyup="lookup(this.value);" >
						</div>
					</div>
