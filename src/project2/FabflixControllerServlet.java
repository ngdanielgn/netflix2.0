...
import project2.CustomHttpServletResponseWrapper;
...
public class FabflixControllerServlet extends HttpServlet {
	...
	public void init() throws ServletException {
		...
		try {
	        ...
	        this.dataSource = (DataSource) envContext.lookup("jdbc/moviedb");
	...
	private void login(HttpServletRequest request, 
		...
		{	if (this.customer != null)
				...
				request.setAttribute("RECAPTCHAFAIL", true);
...
/*	(private void searchByKeywords(HttpServletRequest request, 
	...
	private void movieCard(HttpServletRequest request, 
			HttpServletResponse response) throws Exception {
		...
		Movie movie = database.getMovie(movieId);
		    ...
		    request.getRequestDispatcher("movie-card.jsp").forward(request, customResponse);
